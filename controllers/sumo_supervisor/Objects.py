...
class Vehicle:
    ...
    def generate_vehicle_string(index, vehicleClass):
        ...
        # Add boundingObject based on vehicle class
        if vehicleClass == 'bus':
            vehicleString += "  boundingObject Box { size 12 2.5 3 }\n"
        elif vehicleClass == 'truck' or vehicleClass == 'trailer':
            vehicleString += "  boundingObject Box { size 8 2.5 3.5 }\n"
        elif vehicleClass == 'motorcycle':
            vehicleString += "  boundingObject Box { size 2 0.7 1.2 }\n"
        else:  # car
            vehicleString += "  boundingObject Box { size 4.5 1.8 1.5 }\n"
        vehicleString += "  children [\n" + model + "{\n"
        ...
        if vehicleClass == 'motorcycle':
            ...
            if vehicleClass == 'trailer':
                ...
                if trailerModel == 'TruckTrailerSimple':
                    ...
                    vehicleString += "url [ \"https://raw.githubusercontent.com/cyberbotics/webots/R2025a/projects/vehicles/protos/generic/textures/" + \
